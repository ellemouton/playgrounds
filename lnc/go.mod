module github.com/ellemouton/playgrounds/lnc

go 1.17

require (
	github.com/btcsuite/btcd v0.21.0-beta.0.20210513141527-ee5896bad5be
	github.com/lightninglabs/lightning-node-connect v0.1.6-alpha
...
require (
	...
	github.com/lightningnetwork/lnd/kvdb v1.0.1 // indirect
